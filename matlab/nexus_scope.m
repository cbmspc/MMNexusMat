...
%     end
    ...
    if mod(i-1,10/RefreshPeriod) == 0
        fprintf('[%10.0f ms] Acq=%5.0f ms; Proc=%5.0f ms; Refresh=%5.0f ms; Freetime=%5.0f ms\n',etime(clock,Timer.loopstart)*1000,Timer.acqtotal*1000,Timer.proctotal*1000,RefreshPeriod*1000,MinFreeTime*1000);
    end
